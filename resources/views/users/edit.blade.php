             ...
             <form method="POST" action="{{ route('mypage') }}">
                 ...
                 <div class="form-group">
                     <div class="d-flex justify-content-between">
                         <label for="name" class="text-md-left nm-edit-user-info-label">氏名</label>
                     </div>
                 ...
                 <div class="form-group">
                     <div class="d-flex justify-content-between">
                         <label for="email" class="text-md-left nm-edit-user-info-label">メールアドレス</label>
                     </div>
                 ...
                 <div class="form-group">
                     <div class="d-flex justify-content-between">
                         <label for="postal_code" class="text-md-left nm-edit-user-info-label">郵便番号</label>
                     </div>
                 ...
                 <div class="form-group">
                     <div class="d-flex justify-content-between">
                         <label for="address" class="text-md-left nm-edit-user-info-label">住所</label>
                     </div>
                     <div class="collapse show editUserPhone">
                 ...
                 <div class="form-group">
                     <div class="d-flex justify-content-between">
                         <label for="phone" class="text-md-left nm-edit-user-info-label">電話番号</label>
                     </div>
                     <div class="collapse show editUserPhone">
                 ...
                 <hr>
                 <button type="submit" class="btn nm-submit-button mt-3 w-25">
                     保存
                 </button>
             </form>
         </div>
